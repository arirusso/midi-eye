...
The listener can also be run in a background thread by using :background => true.  This is useful for example if you wanted to run more than one listener on multiple inputs.
